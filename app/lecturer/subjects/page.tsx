...
export default function SubjectsPage() {
  ...
  async function createSubject() {
    ...
    alert("Subject berjaya disimpan!");
    ...
    <div className="min-h-screen bg-slate-100 p-8">
      ...
      <div className="bg-white rounded-3xl shadow-md p-8 mb-10">
        ...
        <button
          ...
          className="mt-8 w-full bg-blue-700 hover:bg-blue-800 text-white py-4 rounded-2xl transition"
        >
          Save Subject
        </button>
      </div>
          ...
          {subjects.map((subject) => (
            ...
            >
              ...
              <button
                ...
                className="mt-3 w-full bg-red-500 hover:bg-red-600 text-white py-3 rounded-xl transition"
              >
                Padam Subject
              </button>
            </div>
